...
:REPOS_URL: https://github.com/kazurayam/websocket-demo/tree/main
...
- link:{REPOS_URL}/src/vanilla-javascript[src/vanilla-javascript/]
...
image:{PAGES_URL}/images/001_index.ts_initial.png[index.ts initial]
...
image:{PAGES_URL}/images/002_index.ts_exchanged.png[index.ts exchanged]
...
image:{PAGES_URL}/images/003_dual_browser_echo_local.png[dual browser echo local]
...
image:{PAGES_URL}/images/004_broadcast.png[broadcast]
...
image:{PAGES_URL}/images/005_mono_directional_messaging.png[mono directional messaging]
...
==== link:{REPOS_URL}/src/vanilla-javascript/index.ts[vanila-javascript/index.ts]
...
==== link:{REPOS_URL}/src/vanilla-javascript/index.html[vanilla-javascript/index.html]
...
==== link:{REPOS_URL}/src/vanilla-javascript/broadcast.ts[vanilla-javascript/broadcast.ts]
...
- link:{REPOS_URL}/src/htmx-ws[src/htmx-ws/]
...
=== link:{REPOS_URL}/src/htmx-ws/index.html[htmx-ws/index.html]
...
=== link:{REPOS_URL}/src/htmx-ws/index.ts[htmx-ws/index.ts]
...
=== link:{REPOS_URL}/src/htmx-ws/broadcast.ts[htmx-ws/broadcast.ts]
...
下記の図は link:{REPOS_URL}/src/htmx-ws/broadcast.ts[htmx-ws/broadcast.ts] を実行した場合のシーケンスです。

image:{PAGES_URL}/diagrams/out/sequence/sequence.png[シーケンス図]

include::./sequence_description.adoc[]
